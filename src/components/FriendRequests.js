        ...
        <div className="p-3 bg-light border rounded" style={{ marginTop: 'var(--header-height, 69px)' }}>
            {friendRequests.length === 0 ? (
                <div className="text-center text-muted" style={{ marginTop: '5px' }}>
                    ...
                    <p className="mb-0" style={{ fontSize: '0.9rem' }}>{t('friendRequests.noRequests')}</p>
                </div>
            ) : (
                <div className="list-group">
                    <h5 className="mb-3" style={{ color: '#FF95AA', fontSize: '1.2rem', fontWeight: 'bold', marginBottom: '10px' }}>{t('friendRequests.pendingList')}</h5>
